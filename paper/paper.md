...
``GB_code`` uses the analytical and mathematical formulations of the following works of @Sutton:1996, @Bollmann:1982, @Grimmer:1974. Some functionality from the code by @Marcin:2013 on CSL has been used in a modified form in the ``GB_code``. 
